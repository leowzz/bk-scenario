...
export function NodeEditor({ node, onChange, onTest, nodeTestState, testStore = {}, onTestStoreChange }) {
  ...
  return (
    <div className="node-editor-panel" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "8px" }}>
        <button className="btn primary" onClick={() => onTest(meta)} disabled={isTesting}>
      ...
      {(testError || testResult) && (
        <div className="node-test-result" style={{ marginTop: "16px", borderTop: "1px solid var(--border-muted)", paddingTop: "16px" }}>
